...
import { ActionIcon, Alert, Checkbox, Fieldset, Group, NativeSelect, NumberInput, Paper, Stack,
  TagsInput, Text, TextInput, Textarea } from '@mantine/core';
    ...
    return (
      <>
        ...
        <TextInput label="Display Name"
          ...
          defaultValue={input.customDisplayName} />
        <Paper withBorder p="xs">
          <FormEditorInputSorter data={[state, handlers]} set={set} remove={remove}
            id={input.rKey} />
          <Group mt="sm" justify="flex-end">
            <ActionIcon onClick={() => openModal((i) => add(i))}>
              <IconPlus />
            </ActionIcon>
          </Group>
        </Paper>
